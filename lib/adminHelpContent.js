...
export const ADMIN_HELP_TOPICS = Object.freeze([
  ...
  helpTopic('blogs-metadata', 'blogs', 'Datos principales', 'Titulo, autor, categoria y extracto definen como se presenta la nota.', {
    ...
    details: 'La categoria agrupa notas en una seccion del blog. Si el extracto queda vacio, el sistema genera uno a partir del contenido.',
  ...
  helpTopic('blogs-tags', 'blogs', 'Tags y busqueda', 'Los tags describen temas puntuales y ayudan a encontrar notas relacionadas.', {
    target: 'blog-tags',
    details: 'Se usan en la busqueda del panel y del blog, y pueden mostrarse como filtros o etiquetas visuales. No crean secciones principales: eso corresponde a la categoria. Usa pocos tags claros y reutiliza los existentes cuando describan el mismo tema.',
    outcome: 'El sistema normaliza y evita tags equivalentes repetidos al guardar.',
