...
export const ADMIN_HELP_TOPICS = Object.freeze([
  ...
  helpTopic('blogs-workflow', 'blogs', 'Flujo editorial', 'Cada accion mueve la nota a una etapa distinta; revisa la vista previa antes de continuar.', {
    ...
    details: 'Guardar conserva cambios. Enviar a revision permite asignar una persona concreta o avisar al equipo completo. Publicar vuelve visible la version aprobada. Archivar la retira del flujo editorial sin eliminarla.',
  ...
  helpTopic('blogs-workflow-author', 'blogs', 'Tu paso en el flujo editorial', 'Guarda tu trabajo y envialo cuando este listo para que el equipo lo revise.', {
    ...
    details: 'Guardar conserva tus cambios. Enviar a revision permite elegir una persona responsable o dejar la nota para todo el equipo, y bloquea la edicion mientras se evalua. Publicar y archivar son decisiones del equipo revisor; no necesitas realizarlas desde tu cuenta.',
  ...
  helpTopic('profile-review-assignment', 'profile', 'Asignaciones de revision', 'Los admin pueden decidir si quieren aparecer como responsables disponibles.', {
    target: 'profile-review-assignment',
    roles: ['admin'],
    details: 'Los reviewer aparecen siempre en la lista de asignacion. Esta preferencia solo controla si tu cuenta admin puede ser elegida individualmente al enviar una nota a revision.',
    outcome: 'Es una preferencia interna: no modifica tus permisos ni publica informacion adicional en el blog.',
  }),
