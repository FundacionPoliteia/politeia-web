...
export function SiteHeader() {
  return <header className="site-header">
    <div className="shell header-inner">
      ...
      <nav aria-label="Navegación principal"><Link href="/#proyectos">Proyectos</Link><Link href="/camino-de-la-ley">Camino de la ley</Link><Link href="/glosario">Glosario</Link><Link href="/nosotros">Nosotros</Link><Link href="/privacidad">Privacidad</Link></nav>
    </div>
  </header>;
}
...
export function SiteFooter() {
  return <footer className="site-footer"><div className="shell">
    <div className="footer-grid">
      ...
      <nav className="footer-column" aria-label="Secciones de Quórum"><h2>Quórum</h2><Link href="/">Inicio</Link><Link href="/#proyectos">Proyectos</Link><Link href="/camino-de-la-ley">Camino de la ley</Link><Link href="/glosario">Glosario</Link><Link href="/nosotros">Nosotros</Link><Link href="/privacidad">Privacidad</Link></nav>
